 ...
 * which then can be registered in BusBuilder with {@link CommandBusBuilder#registerValueProvider(Object)}
 *
 ...
 * annotated with {@link CommandHandler}. But the combination of
